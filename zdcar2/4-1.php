						...
						<tr>
						 ...
						 $i=0;
						  ...
						  foreach($kehus as $row){
							...
							<td>".$row["next_back"]."</td>
							<td><a href='javascript:add(\"xfjl\");xfjla(".$row["id"].")'>查看</a></td>
							<td>".$row["tips"]."</td>
							<td><button class='toolbt' onclick='add(\"ekehu\");ekehua.src=\"ekehu.php?kid=".$row["id"]."&pg=".$pg."\"'>编辑</button><input type='button' class='toolbt' value='删除' onclick='delkh(".$row["id"].",".$pg.")'></td>";
