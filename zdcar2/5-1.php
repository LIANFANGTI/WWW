	...
	<body>
		...
		<div id="main">
			<div class="box">
				<div class="box_title">
					<ul class="ul-tool">
						<li><input type="submit" name="button" id="button" value="今日" class="botton"></li>
						<li><input type="submit" name="button2" id="button2" value="本月" class="botton"></li>
						<li><input type="date" class="text" height=25/></li>
						<li class="to">到</li>
						<li><input type="date" class="text" height=25/></li>
						<li><input type="submit" name="button3" id="button3" value="查询" class="botton"></li>
					</ul>
				</div>
				<div class="box_content" >
					<canvas id="yyeqs" width="1300" height="400"  ></canvas>
					营业额趋势图
				</div>
			</div>
